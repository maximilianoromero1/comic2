...
public class mapa extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(this);
            ...
            Dialog mens = GooglePlayServicesUtil.getErrorDialog(estado,(Activity) getApplicationContext(), i1: 10);
            mens.show();
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(chile).title("Marcador en Chile"));
            icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
            float zoomnivel = 16;
        mMap.moveCamera(CameraUpdateFactory.newLatLng(chile,zoomnivel));
    }
}
